...
- Clientele will now automatically run [Ruff](https://docs.astral.sh/ruff/) formatter and linter once a client is generated or regenerated (previously used Black).
