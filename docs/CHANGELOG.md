...
- **Breaking**: Replaced `openapi-core` dependency with `cicerone==0.2.0` for OpenAPI schema parsing and introspection. This change provides faster, more minimal, and fully typed OpenAPI schema handling.
