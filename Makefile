...
generate-test-clients:  ## regenerate the test clients in the tests/ directory
	...
	uv run clientele generate-framework -f server_examples/fastapi/openapi.json -o server_examples/fastapi/client/ --regen t
	uv run clientele generate-framework -f server_examples/django_rest_framework/openapi.yaml -o server_examples/django_rest_framework/client/ --regen t
	uv run clientele generate-framework -f server_examples/django_ninja/openapi.json -o server_examples/django_ninja/client/ --regen t
