...
"""
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert "PaginatedPokemonSummaryList" in schemas_content, \
            "PaginatedPokemonSummaryList schema not found"
...
"""
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert optional_field.get("type") == "string", \
            "Array type should be converted to base type"
        assert optional_field.get("nullable") is True, \
            "Should have nullable: true after normalization"
