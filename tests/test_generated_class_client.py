...
def test_parameter_request_simple_request(respx_mock: MockRouter):
    ...
    # When
    client = Client()
    response = client.parameter_request_simple_request_parameter_get(parameter="test_parameter")
    # Then
    assert isinstance(response, schemas.SimpleResponse)
    assert len(respx_mock.calls) == 1
    call = respx_mock.calls[0]
...
def test_query_request_simple_query_get(respx_mock: MockRouter):
    ...
    # When
    client = Client()
    response = client.query_request_simple_query_get(yourInput="test")
    # Then
...
def test_query_request_optional_query_get(respx_mock: MockRouter):
    ...
    # When
    client = Client()
    response = client.query_request_optional_query_get(yourInput=None)
    # Then
    assert isinstance(response, schemas.SimpleQueryParametersResponse)
    assert len(respx_mock.calls) == 1
    call = respx_mock.calls[0]
...
def test_request_data_request_data_post(respx_mock: MockRouter):
    ...
    response = client.request_data_request_data_post(data=request_data)
    # Then
...
def test_request_data_request_data_put(respx_mock: MockRouter):
    ...
    client = Client()
    request_data = schemas.RequestDataRequest(my_input="test")
    response = client.request_data_request_data_put(data=request_data)
    # Then
    assert isinstance(response, schemas.RequestDataResponse)
    assert len(respx_mock.calls) == 1
    call = respx_mock.calls[0]
...
def test_request_data_path_request_data(respx_mock: MockRouter):
    ...
    client = Client()
    request_data = schemas.RequestDataRequest(my_input="test")
    response = client.request_data_path_request_data(path_parameter="test_parameter", data=request_data)
    # Then
