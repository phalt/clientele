...
def get_transport() -> httpx.BaseTransport | httpx.AsyncBaseTransport | None:
    """
    Configure a custom transport for the HTTP client.
    Return an httpx transport object to customize low-level HTTP behavior,
    or None to use httpx defaults.

    Use httpx.HTTPTransport for sync clients or httpx.AsyncHTTPTransport for async clients.
