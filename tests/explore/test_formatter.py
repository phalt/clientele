...
def test_format_success_with_pydantic_model():
    ...
    result = ExecutionResult(success=True, response=mock_model, duration=0.3, error=None, debug_info=None)
...
def test_format_success_with_list():
    ...
    formatter = ResponseFormatter()
    result = ExecutionResult(success=True, response=[{"id": 1}, {"id": 2}], duration=0.2, error=None, debug_info=None)
...
def test_format_success_with_none():
    ...
    formatter = ResponseFormatter()
    result = ExecutionResult(success=True, response=None, duration=0.1, error=None, debug_info=None)
...
def test_format_error():
    ...
    result = ExecutionResult(success=False, response=None, duration=0.05, error=error, debug_info=None)
...
def test_format_with_debug_info():
    ...
    formatter = ResponseFormatter()
    debug_info = {"operation": "test_op", "method": "GET", "base_url": "https://api.test.com", "args": {"id": 1}}
    result = ExecutionResult(success=True, response={"result": "ok"}, duration=0.4, error=None, debug_info=debug_info)
...
def test_format_success_with_string():
    ...
    formatter = ResponseFormatter()
    result = ExecutionResult(success=True, response="Plain text response", duration=0.1, error=None, debug_info=None)
