...
from clientele.explore.completer import ExploreCompleter


def test_completer_initialization():
    """Test ExploreCompleter initializes correctly."""
    introspector = Mock()
    introspector.operations = {}
    
    completer = ExploreCompleter(introspector)
