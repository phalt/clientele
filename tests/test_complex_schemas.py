...
class TestOneOfSchemas:
    ...
    @pytest.mark.parametrize("client_generator", [StandardGenerator, ClassbaseGenerator, FrameworkGenerator])
...
class TestAnyOfSchemas:
    ...
    @pytest.mark.parametrize("client_generator", [StandardGenerator, FrameworkGenerator, ClassbaseGenerator])
